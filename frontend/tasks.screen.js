        ...
        render(){
            ...
            return (
		        <View style={styles.container}>
					<View style={{padding:30, height: '90%'}}>
				...
				<View>
					<TabBar onTabChange={(index) => navigation.navigate(getTitle(index))} tabs={tabs} animationDuration={0} 
					initialIndex={1} slideBounciness={0}/>
				</View>
		        </View>
		    )
		}
